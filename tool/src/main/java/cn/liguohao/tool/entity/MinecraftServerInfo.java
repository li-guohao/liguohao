...
public  class MinecraftServerInfo {
	...
	public MinecraftServerInfo(String address) {
		this();

		this.setAddress(address);
	}

	public MinecraftServerInfo(String address,int port) {
		this(address);

		this.setPort(port);
	}

	public MinecraftServerInfo(String address,int port,int timeout) {
		this(address,port);
